...
6. También puedes usar `Examinar archivo` para seleccionar un TXT, PDF o foto. Los TXT se cargan al campo automáticamente; para PDF o foto pega el texto visible para poder analizarlo.
